...
function watching() {
    ...
    watch(['app/js/donate.js'], scriptDonate);
...
exports.scriptDonate = scriptDonate;
...
exports.default = parallel(styles, scripts, scriptDonate, browsersync, watching);